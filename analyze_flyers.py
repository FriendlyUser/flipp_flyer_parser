...
def main():
    ...
    try:
        ...
        prompt = (
            ...
            + "\n\n-------- ITEMS that are higher priority if available and good value include: \n"
            + "Golden Pompano Fish, Silk (plant-based milk), Garlic, Tomatoes, Pasta, SkyFlakes crackers, Pork tenderloin, Blueberries, Strawberries, Bananas, Oranges, Pork Side Ribs, Pork Back Ribs, Ground Pork, Chicken Wings, Cereal, Bread, Coconut Bread, Sunflower Seeds"
            + "\n--------\n\nYour Suggestions:"
        )
